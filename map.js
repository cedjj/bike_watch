...
mapboxgl.accessToken = 'pk.eyJ1IjoiY2VqZW5nIiwiYSI6ImNtaHdtOG83NTAxNDgyanExbGpiM2Y3emsifQ.1lZnPhu2xViUKbiH40D-XQ';

// Initialize the map
const map = new mapboxgl.Map({
  container: 'map', // ID of the div where the map will render
  style: 'mapbox://styles/mapbox/streets-v12', // Map style
  center: [-71.07816861289184, 42.34955860634445], // [longitude, latitude]
...
function computeStationTraffic(stations, timeFilter = -1) {
  ...
  return stations.map((station) => {let id = station.short_name;
